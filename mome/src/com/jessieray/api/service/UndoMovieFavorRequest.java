...
public class UndoMovieFavorRequest {
     ...
     *           电影id
     */
    public static void findUndoMovieFavor(java.lang.String userid, java.lang.String movieid, ResponseCallback response) {
        String url = RequestProxy.getRequest().getRequestUrl() + "/undoMovieFavor.shtml";
        java.util.Map<String, String> params = new java.util.HashMap<String, String>();
        params.put("userid", RequestUtils.object2String(userid));
        params.put("movieid", RequestUtils.object2String(movieid));
        resultType = new com.google.gson.reflect.TypeToken<ResponseResult<UndoMovieFavor>>() {}.getType();
