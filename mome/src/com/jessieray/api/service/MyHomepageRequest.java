...
public class MyHomepageRequest {
     ...
     *           用户ID
     */
    public static void findMyHomepage(java.lang.String userid, ResponseCallback response) {
        String url = RequestProxy.getRequest().getRequestUrl() + "/MyHomepage.shtml";
        java.util.Map<String, String> params = new java.util.HashMap<String, String>();
        params.put("userid", RequestUtils.object2String(userid));
        resultType = new com.google.gson.reflect.TypeToken<ResponseResult<MyHomepage>>() {}.getType();
