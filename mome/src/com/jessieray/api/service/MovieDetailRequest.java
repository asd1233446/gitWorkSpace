...
public class MovieDetailRequest {
     ...
     *           电影id
     */
    public static void findMovieDetail(java.lang.String userid, java.lang.String movieid, ResponseCallback response) {
        String url = RequestProxy.getRequest().getRequestUrl() + "/movieDetail.shtml";
        java.util.Map<String, String> params = new java.util.HashMap<String, String>();
        params.put("userid", RequestUtils.object2String(userid));
        params.put("movieid", RequestUtils.object2String(movieid));
        resultType = new com.google.gson.reflect.TypeToken<ResponseResult<MovieDetail>>() {}.getType();
