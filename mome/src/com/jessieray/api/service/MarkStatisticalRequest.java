...
public class MarkStatisticalRequest {
     ...
     *           年
     */
    public static void findMarkStatistical(java.lang.String userid, java.lang.String date, ResponseCallback response) {
        String url = RequestProxy.getRequest().getRequestUrl() + "/markStatistical.shtml";
        java.util.Map<String, String> params = new java.util.HashMap<String, String>();
        params.put("userid", RequestUtils.object2String(userid));
        params.put("date", RequestUtils.object2String(date));
        resultType = new com.google.gson.reflect.TypeToken<ResponseResult<MarkStatistical>>() {}.getType();
