...
public class AddttentionRequest {
     ...
     */
    public static void findAddttention(java.lang.String userid,java.lang.String relatedid, ResponseCallback response) {
        String url = RequestProxy.getRequest().getRequestUrl() + "/addttention.shtml";
        ...
        resultType = new com.google.gson.reflect.TypeToken<ResponseResult<Addttention>>() {}.getType();
