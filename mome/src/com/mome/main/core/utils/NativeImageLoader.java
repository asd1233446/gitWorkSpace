...
//	    }
	     ...
	     */
	    Bitmap bitmap ;
	    public void loadNativeImage(final ImageView image,final String path, final Point mPoint, final NativeImageCallBack mCallBack){
	        //先获取内存中的Bitmap
	        ...
	        if(bitmap == null){
	            mImageThreadPool.execute(new Runnable() {
	                ...
	                public void run() {
	                  ...
	                  Log.e("NativeImageLoading", "请求本地图片"+path);
	    ...
	    private Bitmap decodeThumbBitmapForFile(String path, int viewWidth, int viewHeight){
	     ...
	     // 利用ThumbnailUtils来创建缩略图，这里要指定要缩放哪个Bitmap对象  
	       ...
	       Log.e("内存", "图片内存"+bitmap.getWidth()*bitmap.getHeight()*2/1024+"宽"+bitmap.getWidth()+"高"+bitmap.getHeight());
	        return  bitmap;
	    }
