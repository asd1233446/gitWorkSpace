...
public class UserNickName extends Activity implements OnClickListener{
...
protected void onCreate(Bundle savedInstanceState) {
	...
	setContentView(R.layout.update_usernickname);
	userSign=(EditText) findViewById(R.id.userNickName_et);
	...
	intent=getIntent();
	userSign.setText(intent.getExtras().getString("nickName"));
...
public void onClick(View v) {
	...
	case R.id.titlebar_right:
		intent.putExtra("nickName", userSign.getText().toString());
